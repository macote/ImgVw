...
inline std::wstring DebugHelper::FormatWindowMessage(MSG msg)
{
    ...
    auto messagecode = kWindowsMessageCodeMap.find(msg.message) == kWindowsMessageCodeMap.end()
                           ? L""
                           : L" (" + kWindowsMessageCodeMap.at(msg.message) + L")";
...
{
    std::wstringstream wss;
    auto messagecode = kWindowsMessageCodeMap.find(uMsg) == kWindowsMessageCodeMap.end()
                           ? L""
                           : L" (" + kWindowsMessageCodeMap.at(uMsg) + L")";
