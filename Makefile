...
OBJECTS = ${OBJDIR}/ColorProfile.o ${OBJDIR}/ColorTransform.o ${OBJDIR}/ExifOrientation.o ${OBJDIR}/FileOperations.o ${OBJDIR}/ImageDispatcher.o ${OBJDIR}/ImageFormatDetector.o ${OBJDIR}/ImageFormatResolver.o ${OBJDIR}/ImageHeaderProbe.o ${OBJDIR}/ImgResampler.o ${OBJDIR}/ImgFileList.o ${OBJDIR}/ImgRenderer.o ${OBJDIR}/ImgBrowser.o ${OBJDIR}/ImgBuffer.o ${OBJDIR}/ImgGDIItem.o ${OBJDIR}/ImgHEIFItem.o ${OBJDIR}/ImgItem.o ${OBJDIR}/ImgItemHelper.o ${OBJDIR}/ImgJPEGDecoder.o ${OBJDIR}/ImgJPEGItem.o ${OBJDIR}/ImgLoader.o ${OBJDIR}/ImgVwWindow.o ${OBJDIR}/PathPicker.o ${OBJDIR}/ProcessDpiAwareness.o ${OBJDIR}/Program.o ${OBJDIR}/Window.o ${OBJDIR}/ImgVw.o
